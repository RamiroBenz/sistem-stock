	<?php
		...
		{
	?>
<nav class="navbar navbar-default " style="background-color: #7d0505;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"> Lola Morena  </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="contacto/contacto.php" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Contacto</a></li>
        <li><a href="http://www.rbcreacionesweb.com" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Pagina..</a></li>
